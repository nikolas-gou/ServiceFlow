...
import type { DetailImage } from '../../../types/repairCards';
...
interface CardPhotosProps {
  repair: { images?: DetailImage[] | null };
}

export const CardPhotos = ({ repair }: CardPhotosProps) => {
  ...
  const getImageUrl = (image: DetailImage): string => {
