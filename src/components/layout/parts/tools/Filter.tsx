...
import type { RepairFilterValues } from '../../../../types/searchFilters';
import type { RepairJSON } from '../../../Models/Repair';

const EMPTY_FILTERS: RepairFilterValues = {
  status: '',
  typeOfMotor: '',
  manufacturer: '',
  voltType: '',
...
interface FilterProps {
  repairs?: RepairJSON[];
  filters?: RepairFilterValues;
  onFiltersChange?: (filters: RepairFilterValues) => void;
}

export default function Filter({ repairs, filters, onFiltersChange }: FilterProps) {
  ...
  const manufacturers = [...new Set(repairs?.map((r) => r.motor?.manufacturer).filter(Boolean))];

  const handleFilterChange = (key: keyof RepairFilterValues, value: string) => {
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
                <StyledFormControl fullWidth size="small">
                  ...
                  <StyledSelect
                    ...
                    label="Κατάσταση"
                    onChange={(e: SelectChangeEvent<unknown>) => handleFilterChange('status', e.target.value as string)}
                  >
                ...
                <StyledFormControl fullWidth size="small">
                  ...
                  <StyledSelect
                    ...
                    label="Τύπος"
                    onChange={(e: SelectChangeEvent<unknown>) => handleFilterChange('typeOfMotor', e.target.value as string)}
                  >
            ...
            <Stack spacing={1.5}>
              ...
              <StyledFormControl fullWidth size="small">
                ...
                <StyledSelect
                  ...
                  label="Μάρκα"
                  onChange={(e: SelectChangeEvent<unknown>) => handleFilterChange('manufacturer', e.target.value as string)}
                >
                  <MenuItem value="">Όλες</MenuItem>
                  {manufacturers.map((m) => (
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
                <StyledFormControl fullWidth size="small">
                  ...
                  <StyledSelect
                    ...
                    label="Τάση"
                    onChange={(e: SelectChangeEvent<unknown>) => handleFilterChange('voltType', e.target.value as string)}
                  >
                    <MenuItem value="">Όλες</MenuItem>
                    {volt_types.map((v) => (
                ...
                <StyledFormControl fullWidth size="small">
                  ...
                  <StyledSelect
                    ...
                    label="Στροφές"
                    onChange={(e: SelectChangeEvent<unknown>) => handleFilterChange('rpm', e.target.value as string)}
                  >
                    <MenuItem value="">Όλες</MenuItem>
                    {rpm_types.map((r) => (
