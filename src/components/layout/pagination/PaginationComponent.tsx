import { Box, IconButton, Typography, Select, MenuItem, styled, type SelectChangeEvent } from '@mui/material';
...
const PageButton = styled(IconButton)<ActivePageProps>(({ theme, isActive }) => ({
  width: '36px',
  height: '36px',
  borderRadius: '10px',
  margin: '0 3px',
...
const PageNumberButton = styled(IconButton)<ActivePageProps>(({ theme, isActive }) => ({
  width: '36px',
  height: '36px',
  borderRadius: '10px',
  margin: '0 3px',
...
export default function PaginationComponent({
  ...
  const startItem = (currentPage - 1) * itemsPerPageNum + 1;
  const endItem = Math.min(currentPage * itemsPerPageNum, totalItems);
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        {showItemsPerPage && (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, ml: 2 }}>
            ...
            <StyledSelect value={itemsPerPageNum} onChange={handleItemsPerPageChange} size="small">
