...
import { SectionLabel, SegmentedToggle } from '../../../common/styled/FormDesignSystem';
 ...
 */
function TypeOfStepFieldV2({ repair, handleInputChange }) {
  ...
  const options = typeOfStep.map((type, index) => ({
    value: type,
    label: LABELS[type],
