...
interface ThreePhaseFieldsProps {
  step_label?: string;
  step_name: string;
  step_value?: string | number | null;
  coils_count_label?: string;
  coils_count_name: string;
  coils_count_value?: number | string | null;
  spiral_label?: string;
  spiral_name: string;
...
function ThreePhaseFields(props: ThreePhaseFieldsProps) {
  return (
