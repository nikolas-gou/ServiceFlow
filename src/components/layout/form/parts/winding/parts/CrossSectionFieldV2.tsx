...
import { Autocomplete, Box, type SxProps, type Theme } from '@mui/material';
...
interface CrossSectionFieldV2Props {
 ...
 */
export const CrossSectionFieldV2 = (props: CrossSectionFieldV2Props) => {
