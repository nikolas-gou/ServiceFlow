...
import type { ConnectionFormBagProps } from '../../../../../types/connectionForm';

type BasicInfoConnectionProps = Pick<ConnectionFormBagProps, 'connection' | 'handleInputChange'>;

export const BasicInfoConnection = (props: BasicInfoConnectionProps) => {
  return (
