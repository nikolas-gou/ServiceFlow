...
type TechnicalCharacteristicsProps = Pick<RepairFormBagProps, 'repair' | 'handleInputChange'>;

export const TechnicalCharacteristics = (props: TechnicalCharacteristicsProps) => {
  return (
