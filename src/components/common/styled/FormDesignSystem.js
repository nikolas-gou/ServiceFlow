...
export function HelperText({ children, error, sx }) {
  return (
    <Typography
      component="div"
      sx={(theme) => ({
...
export function NumberBadge({ children, color }) {
  return (
    <Box
      sx={(theme) => {
        const accent = color || theme.palette.primary.main;
 ...
 */
export function SegmentedToggle({ value, onChange, options, sx }) {
  return (
    <Box
      sx={{
        display: 'flex',
...
export function DesignChip({ label, onDelete }) {
  return (
    <Box
      sx={(theme) => ({
        display: 'inline-flex',
...
export function MonoValue({ children, sx }) {
  return (
    <Box
      component="span"
      sx={{
