              ...
              <TabPanel>
                ...
                <HeroCard sx={{ m: 0, mb: 3 }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <StatsChipsContainer>
                      <StatsChip
                        label={`Συνολικοί: ${formatValue(motor.totalMotors)}`}
                        icon={<Assessment />}
                      />
                      <StatsChip
                        label={`Μονοφασικοί: ${formatValue(types.totalOnePhaseMotors)}`}
                        icon={<ElectricBolt />}
                      />
                      <StatsChip
                        label={`Τριφασικοί: ${formatValue(types.totalThreePhaseMotors)}`}
                        icon={<Power />}
                      />
                    </StatsChipsContainer>
                  </Box>
