...
const getGradientBackground = (colorName?: string): [string, string] => {
  ...
  return (colorName && baseColors[colorName]) || baseColors.primary;
};
...
export const StatisticCard = (props: StatisticCardProps) => {
  ...
  const getTooltipMessage = (): string => {
    ...
    const message = props.errorMessage || 'Σφάλμα φόρτωσης δεδομένων';
